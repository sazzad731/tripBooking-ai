...
export default function TravelDeals() {
  return (
    <section className="bg-[#0640C3] py-14 md:py-20 md:mx-15 my-14.5 relative">
      <div className="max-w-312 mx-auto overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="max-w-170 text-[clamp(32px,4vw,40px)] font-bold leading-[1.12] text-white">
            Find The Best Travel Deals Instantly With AI!
          </h2>

          <p className="mt-5 max-w-[677.53px] text-base text-white/75 font-normal mb-[50px]">
